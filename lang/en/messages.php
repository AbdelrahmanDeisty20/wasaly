...
return [
    ...
    'page_recived_successfully' => 'pages received successfully',
    'settings_retrieved_successfully' => 'settings received successfully',
    ...
    'start_time_format' => 'Start time format is invalid (should be HH:mm)',
    ...
    'description_en_required' => 'Service description in English is required',
    ...
    'min_price_must_be_numeric' => 'Minimum price must be a number',
    'max_price_must_be_numeric' => 'Maximum price must be a number',
    'sort_must_be_in_top_rated_latest' => 'Sort order must be one of: top_rated, latest',
    ...
    'availability_required' => 'Availability data is required',
    'availability_array' => 'Availability data must be an array',
    'date_required' => 'Date is required',
    'times_required' => 'Times are required',
    ...
    'associations' => 'Associations (Categories & Brand)',
    'media' => 'Media',
    ...
    'user_type_status' => 'User Type & Status',
    ...
    'product_owner' => 'Owner / Provider',
    'admin_wasaly' => 'Admin (Wasaly)',
    'without_provider' => 'No provider link',
    'is_provider_product' => 'Is this product for a Service Provider?',
    'provider_hint' => 'Select a provider below to link this product automatically — leave empty if not applicable',
    'optional_provider' => 'Service Provider (optional)',
    ...
    'app' => 'App',
    'general_app_review' => 'General App Review',
