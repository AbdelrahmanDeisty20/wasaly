                    ...
                    function (array $row) {
                        ...
                        if (!$user) {
                            $user = \App\Models\User::create([
                                ...
                                'phone' => ($row['user_phone'] ?? $row['هاتف_المستخدم'] ?? '') ?: null,
                        ...
                        \App\Models\Provider::create([
                            ...
                            'service_description_ar' => mb_substr($row['service_description_ar'] ?? $row['الوصف_عربي'] ?? '', 0, 255),
                            'service_description_en' => mb_substr($row['service_description_en'] ?? $row['الوصف_إنجليزي'] ?? '', 0, 255),
