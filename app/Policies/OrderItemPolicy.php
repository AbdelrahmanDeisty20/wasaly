...
class OrderItemPolicy
{
    ...
    public function view(AuthUser $authUser, OrderItem $model): bool
    {
    ...
    public function update(AuthUser $authUser, OrderItem $model): bool
    {
        return $authUser->can('Update:OrderItem');
    }

    public function delete(AuthUser $authUser, OrderItem $model): bool
    {
        return $authUser->can('Delete:OrderItem');
    }

    public function restore(AuthUser $authUser, OrderItem $model): bool
    {
        return $authUser->can('Restore:OrderItem');
    }

    public function forceDelete(AuthUser $authUser, OrderItem $model): bool
    {
    ...
    public function replicate(AuthUser $authUser, OrderItem $model): bool
    {
