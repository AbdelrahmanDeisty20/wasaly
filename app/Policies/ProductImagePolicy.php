...
class ProductImagePolicy
{
    ...
    public function view(AuthUser $authUser, ProductImage $model): bool
    {
    ...
    public function update(AuthUser $authUser, ProductImage $model): bool
    {
        return $authUser->can('Update:ProductImage');
    }

    public function delete(AuthUser $authUser, ProductImage $model): bool
    {
        return $authUser->can('Delete:ProductImage');
    }

    public function restore(AuthUser $authUser, ProductImage $model): bool
    {
        return $authUser->can('Restore:ProductImage');
    }

    public function forceDelete(AuthUser $authUser, ProductImage $model): bool
    {
    ...
    public function replicate(AuthUser $authUser, ProductImage $model): bool
    {
