...
class AddressPolicy
{
    ...
    public function view(AuthUser $authUser, Address $model): bool
    {
    ...
    public function update(AuthUser $authUser, Address $model): bool
    {
        return $authUser->can('Update:Address');
    }

    public function delete(AuthUser $authUser, Address $model): bool
    {
        return $authUser->can('Delete:Address');
    }

    public function restore(AuthUser $authUser, Address $model): bool
    {
        return $authUser->can('Restore:Address');
    }

    public function forceDelete(AuthUser $authUser, Address $model): bool
    {
    ...
    public function replicate(AuthUser $authUser, Address $model): bool
    {
