...
class GovernoratePolicy
{
    ...
    public function view(AuthUser $authUser, Governorate $model): bool
    {
    ...
    public function update(AuthUser $authUser, Governorate $model): bool
    {
        return $authUser->can('Update:Governorate');
    }

    public function delete(AuthUser $authUser, Governorate $model): bool
    {
        return $authUser->can('Delete:Governorate');
    }

    public function restore(AuthUser $authUser, Governorate $model): bool
    {
        return $authUser->can('Restore:Governorate');
    }

    public function forceDelete(AuthUser $authUser, Governorate $model): bool
    {
    ...
    public function replicate(AuthUser $authUser, Governorate $model): bool
    {
