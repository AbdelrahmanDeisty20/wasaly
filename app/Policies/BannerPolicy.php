...
class BannerPolicy
{
    ...
    public function view(AuthUser $authUser, Banner $model): bool
    {
    ...
    public function update(AuthUser $authUser, Banner $model): bool
    {
        return $authUser->can('Update:Banner');
    }

    public function delete(AuthUser $authUser, Banner $model): bool
    {
        return $authUser->can('Delete:Banner');
    }

    public function restore(AuthUser $authUser, Banner $model): bool
    {
        return $authUser->can('Restore:Banner');
    }

    public function forceDelete(AuthUser $authUser, Banner $model): bool
    {
    ...
    public function replicate(AuthUser $authUser, Banner $model): bool
    {
